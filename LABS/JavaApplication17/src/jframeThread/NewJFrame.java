        ...
        Thread t1 = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    smp.applyPattern("hh:mm:ss aa");
                    while (true) {
                        Date d = new Date();
                        String text = smp.format(d);
                        clock.setText(text);
                        Thread.sleep(1000);
                }}catch(Exception e){
                    e.printStackTrace();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(clock, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(44, 44, 44))
        );
