...
public class EmployeeManagement extends javax.swing.JFrame {
    ...
    public EmployeeManagement() {
        ...
        listEmp.add(new Employee("PH07680", "Pham Minh Tuan ", "tuanpmph07680@gmail.com", 20, 20000000));
        listEmp.add(new Employee("PH07681", "Nguyen Y Nhi ", "nhiph07680@gmail.com", 20, 21000000));
        listEmp.add(new Employee("PH07683", "Nguy huy hai", "haipmph07680@gmail.com", 20, 8000000));
        listEmp.add(new Employee("PH07684", "Phung Phuong Thao", "thaor@gmail.com", 20, 10000000));
        index = 0;
        fillToTable();
        showDetail();
    ...
    public void showPositon(){
        if(index ==-1){
            tf_number_record.setText("NO DATA");
        }else {
            index = tb_list.getSelectedRow();
            tf_number_record.setText(String.valueOf(index + 1) + " / " + listEmp.size());
        }
    }
    ...
    public void removeData() {
        if (index >= 0) {
            ...
            JOptionPane.showMessageDialog(this, "Bạn phải chọn một hàng trên table");
        }
    }
    ...
    public void updateData() {
        try {
            if(duplicateCheck(tf_mnv.getText()) == false){
            getData();
            
            listEmp.add(index, employee);
            listEmp.remove(index);
    ...
    public void prevFist(){
        if(index >= 0){
            if(tb_list.getSelectedRow() == 0){
                tb_list.setRowSelectionInterval(listEmp.size()-1, listEmp.size()-1);
            }else{
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        ...
        try {
            ...
            System.out.println("Lỗi index " + e);
        }
